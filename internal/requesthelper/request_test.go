...
func (e *ErrorDownloader) GetRequest(ctx *log.Context, eTag string) (*http.Request, error) {
	e.calls++
	return nil, e.err
}
...
func (b *BadRequestor) GetRequest(ctx *log.Context, eTag string) (*http.Request, error) {
	b.calls++
